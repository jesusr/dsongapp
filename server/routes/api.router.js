...
router
    ...
    .get(function(req, res) {
        ...
        Artist.find(function(err, data) {
            ...
            var numPages = Math.floor(data.length / parseInt(limit)) + ((data.length / parseInt(limit)) >
                Math.floor(data.length / parseInt(limit)) ? 1 : 0);
            ...
            if (parseInt(page) > numPages || parseInt(page) === 0) {
                ...
                res.json({
                    'data': data.slice(begin, begin + parseInt(limit)),
                    'page': page,
                    'pageTotal': numPages,
                    'pageInfo': pageInfo
                });
